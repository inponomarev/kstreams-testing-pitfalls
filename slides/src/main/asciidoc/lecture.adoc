...
digraph G {
  rankdir="LR";
  graph [ dpi = 180 ];
  source [shape=record;label="{K|V|Headers|Timestamp}|{K|V|Headers|Timestamp}|{K|V|Headers|Timestamp}"];
  processor [shape="septagon"; label="\nTopology\n "];
  sink [shape=record;label="{K|V|Headers|Timestamp}|{K|V|Headers|Timestamp}|{K|V|Headers|Timestamp}"];
